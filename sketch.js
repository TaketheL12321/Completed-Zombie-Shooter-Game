...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
   player.scale = 0.3
   player.debug = false
   player.setCollider("rectangle",0,0,250,30)
...
// displaying score and remaining lives and bullets of the player
textSize(20)
fill("white")
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(750,1100),random(100,500),40,40)
